...
namespace Microsoft.ServiceFabric.Powershell.Http
{
    ...
    public partial class UpdateBackupPolicyCmdlet : CommonCmdletBase
    {
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 15, ParameterSetName = "_TimeBased__AzureBlobStore__Basic_")]
        [Parameter(Mandatory = false, Position = 15, ParameterSetName = "_TimeBased__FileShare__Basic_")]
        [Parameter(Mandatory = false, Position = 15, ParameterSetName = "_TimeBased__DsmsAzureBlobStore__Basic_")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 21, ParameterSetName = "_FrequencyBased__AzureBlobStore__Basic_")]
        [Parameter(Mandatory = false, Position = 21, ParameterSetName = "_FrequencyBased__FileShare__Basic_")]
        [Parameter(Mandatory = false, Position = 21, ParameterSetName = "_FrequencyBased__DsmsAzureBlobStore__Basic_")]
        [Parameter(Mandatory = false, Position = 21, ParameterSetName = "_TimeBased__AzureBlobStore__Basic_")]
        [Parameter(Mandatory = false, Position = 21, ParameterSetName = "_TimeBased__FileShare__Basic_")]
        [Parameter(Mandatory = false, Position = 21, ParameterSetName = "_TimeBased__DsmsAzureBlobStore__Basic_")]
