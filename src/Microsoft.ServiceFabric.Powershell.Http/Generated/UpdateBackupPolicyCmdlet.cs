...
namespace Microsoft.ServiceFabric.Powershell.Http
{
    ...
    public partial class UpdateBackupPolicyCmdlet : CommonCmdletBase
    {
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 2, ParameterSetName = "UpdateBackupPolicy")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 3, ParameterSetName = "UpdateBackupPolicy")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 4, ParameterSetName = "UpdateBackupPolicy")]
        ...
        /// </summary>
        [Parameter(Mandatory = true, Position = 11, ParameterSetName = "UpdateBackupPolicy")]
        public string ConnectionString { get; set; }

        /// <summary>
        /// Gets or sets ContainerName. The name of the container in the blob store to store and enumerate backups from.
        /// </summary>
        [Parameter(Mandatory = true, Position = 12, ParameterSetName = "UpdateBackupPolicy")]
        public string ContainerName { get; set; }

        /// <summary>
        /// Gets or sets Path. UNC path of the file share where to store or enumerate backups from.
        /// </summary>
        [Parameter(Mandatory = true, Position = 13, ParameterSetName = "UpdateBackupPolicy")]
        ...
        /// </summary>
        [Parameter(Mandatory = true, Position = 14, ParameterSetName = "UpdateBackupPolicy")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 22, ParameterSetName = "UpdateBackupPolicy")]
