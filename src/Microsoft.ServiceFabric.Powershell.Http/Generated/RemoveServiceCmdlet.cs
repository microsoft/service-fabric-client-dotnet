...
namespace Microsoft.ServiceFabric.Powershell.Http
{
    ...
    public partial class RemoveServiceCmdlet : CommonCmdletBase
    {
        ...
        /// </summary>
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, Position = 0, ParameterSetName = "DeleteService")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 1, ParameterSetName = "DeleteService")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 2, ParameterSetName = "DeleteService")]
        ...
        protected override void ProcessRecordInternal()
        {
            ...
            {
                this.ServiceFabricClient.Services.DeleteServiceAsync(
