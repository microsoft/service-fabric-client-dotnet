...
namespace Microsoft.ServiceFabric.Powershell.Http
{
    ...
    public partial class GetDeployedServicePackageHealthCmdlet : CommonCmdletBase
    {
        ...
        /// </summary>
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, Position = 0, ParameterSetName = "GetDeployedServicePackageHealth")]
        ...
        /// </summary>
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, Position = 1, ParameterSetName = "GetDeployedServicePackageHealth")]
        ...
        /// </summary>
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, Position = 2, ParameterSetName = "GetDeployedServicePackageHealth")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 3, ParameterSetName = "GetDeployedServicePackageHealth")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 4, ParameterSetName = "GetDeployedServicePackageHealth")]
        ...
        {
            var result = this.ServiceFabricClient.ServicePackages.GetDeployedServicePackageHealthAsync(
