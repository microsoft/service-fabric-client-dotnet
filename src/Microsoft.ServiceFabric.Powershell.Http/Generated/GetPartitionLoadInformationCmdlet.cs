...
namespace Microsoft.ServiceFabric.Powershell.Http
{
    ...
    public partial class GetPartitionLoadInformationCmdlet : CommonCmdletBase
    {
        ...
        /// </summary>
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, Position = 0, ParameterSetName = "GetPartitionLoadInformation")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 1, ParameterSetName = "GetPartitionLoadInformation")]
        ...
        protected override void ProcessRecordInternal()
        {
            try
            {
                var result = this.ServiceFabricClient.Partitions.GetPartitionLoadInformationAsync(
