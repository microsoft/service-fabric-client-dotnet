...
namespace Microsoft.ServiceFabric.Powershell.Http
{
    ...
    public partial class SuspendApplicationBackupCmdlet : CommonCmdletBase
    {
        ...
        /// </summary>
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, Position = 0, ParameterSetName = "SuspendApplicationBackup")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 1, ParameterSetName = "SuspendApplicationBackup")]
        ...
        protected override void ProcessRecordInternal()
        {
            ...
            {
                this.ServiceFabricClient.BackupRestore.SuspendApplicationBackupAsync(
