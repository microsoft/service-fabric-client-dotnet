...
namespace Microsoft.ServiceFabric.Powershell.Http
{
    ...
    public partial class ResumeApplicationBackupCmdlet : CommonCmdletBase
    {
        ...
        /// </summary>
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, Position = 0, ParameterSetName = "ResumeApplicationBackup")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 1, ParameterSetName = "ResumeApplicationBackup")]
        ...
        {
            this.ServiceFabricClient.BackupRestore.ResumeApplicationBackupAsync(
