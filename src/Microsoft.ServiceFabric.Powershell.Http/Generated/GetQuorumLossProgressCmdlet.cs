...
namespace Microsoft.ServiceFabric.Powershell.Http
{
    ...
    public partial class GetQuorumLossProgressCmdlet : CommonCmdletBase
    {
        ...
        /// </summary>
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, Position = 0, ParameterSetName = "GetQuorumLossProgress")]
        ...
        /// </summary>
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, Position = 1, ParameterSetName = "GetQuorumLossProgress")]
        ...
        /// GetProgress API
        /// </summary>
        [Parameter(Mandatory = true, Position = 2, ParameterSetName = "GetQuorumLossProgress")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 3, ParameterSetName = "GetQuorumLossProgress")]
        ...
        {
            var result = this.ServiceFabricClient.Faults.GetQuorumLossProgressAsync(
