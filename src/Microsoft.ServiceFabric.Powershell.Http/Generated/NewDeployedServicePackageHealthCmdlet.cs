...
namespace Microsoft.ServiceFabric.Powershell.Http
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "SFDeployedServicePackageHealth", DefaultParameterSetName = "ReportDeployedServicePackageHealth")]
    public partial class NewDeployedServicePackageHealthCmdlet : CommonCmdletBase
    {
        /// <summary>
        /// Gets or sets NodeName. The name of the node.
        /// </summary>
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, Position = 0, ParameterSetName = "ReportDeployedServicePackageHealth")]
        ...
        /// </summary>
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, Position = 1, ParameterSetName = "ReportDeployedServicePackageHealth")]
        ...
        /// </summary>
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, Position = 2, ParameterSetName = "ReportDeployedServicePackageHealth")]
        ...
        /// health information.
        /// </summary>
        [Parameter(Mandatory = true, Position = 3, ParameterSetName = "ReportDeployedServicePackageHealth")]
        ...
        /// </summary>
        [Parameter(Mandatory = true, Position = 4, ParameterSetName = "ReportDeployedServicePackageHealth")]
        ...
        /// </summary>
        [Parameter(Mandatory = true, Position = 5, ParameterSetName = "ReportDeployedServicePackageHealth")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 6, ParameterSetName = "ReportDeployedServicePackageHealth")]
        public TimeSpan? TimeToLiveInMilliSeconds
        {
            get;
            set;
        }
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 7, ParameterSetName = "ReportDeployedServicePackageHealth")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 8, ParameterSetName = "ReportDeployedServicePackageHealth")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 9, ParameterSetName = "ReportDeployedServicePackageHealth")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 10, ParameterSetName = "ReportDeployedServicePackageHealth")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 11, ParameterSetName = "ReportDeployedServicePackageHealth")]
        ...
        protected override void ProcessRecordInternal()
        {
            try
            {
                ...
                this.ServiceFabricClient.ServicePackages.ReportDeployedServicePackageHealthAsync(
