...
namespace Microsoft.ServiceFabric.Powershell.Http
{
    ...
    public partial class NewInfrastructureCommandCmdlet : CommonCmdletBase
    {
        ...
        /// </summary>
        [Parameter(Mandatory = true, Position = 0, ParameterSetName = "InvokeInfrastructureCommand")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 1, ParameterSetName = "InvokeInfrastructureCommand")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 2, ParameterSetName = "InvokeInfrastructureCommand")]
