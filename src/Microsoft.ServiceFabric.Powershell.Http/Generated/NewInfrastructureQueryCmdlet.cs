...
namespace Microsoft.ServiceFabric.Powershell.Http
{
    ...
    public partial class NewInfrastructureQueryCmdlet : CommonCmdletBase
    {
        ...
        /// </summary>
        [Parameter(Mandatory = true, Position = 0, ParameterSetName = "InvokeInfrastructureQuery")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 1, ParameterSetName = "InvokeInfrastructureQuery")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 2, ParameterSetName = "InvokeInfrastructureQuery")]
        ...
        {
            var result = this.ServiceFabricClient.Infrastructure.InvokeInfrastructureQueryAsync(
