...
namespace Microsoft.ServiceFabric.Powershell.Http
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "SFMeshNetworkApplicationRefList", DefaultParameterSetName = "GetMeshNetworkApplicationRefList")]
    public partial class GetMeshNetworkApplicationRefListCmdlet : CommonCmdletBase
    {
        /// <summary>
        ...
        /// </summary>
        [Parameter(Mandatory = true, Position = 0, ParameterSetName = "GetMeshNetworkApplicationRefList")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 1, ParameterSetName = "GetMeshNetworkApplicationRefList")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 2, ParameterSetName = "GetMeshNetworkApplicationRefList")]
        ...
        protected override void ProcessRecordInternal()
        {
            try
            {
                ...
                do
                {
                    var result = this.ServiceFabricClient.MeshNetworks.GetMeshNetworkApplicationRefListAsync(
