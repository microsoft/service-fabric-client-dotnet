...
namespace Microsoft.ServiceFabric.Powershell.Http
{
    ...
    public partial class GetPartitionBackupProgressCmdlet : CommonCmdletBase
    {
        ...
        /// </summary>
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, Position = 0, ParameterSetName = "GetPartitionBackupProgress")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 1, ParameterSetName = "GetPartitionBackupProgress")]
        ...
        protected override void ProcessRecordInternal()
        {
            try
            {
                var result = this.ServiceFabricClient.BackupRestore.GetPartitionBackupProgressAsync(
