...
namespace Microsoft.ServiceFabric.Powershell.Http
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "SFDeployedApplicationHealthUsingPolicy", DefaultParameterSetName = "GetDeployedApplicationHealthUsingPolicy")]
    public partial class GetDeployedApplicationHealthUsingPolicyCmdlet : CommonCmdletBase
    {
        /// <summary>
        /// Gets or sets NodeName. The name of the node.
        /// </summary>
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, Position = 0, ParameterSetName = "GetDeployedApplicationHealthUsingPolicy")]
        ...
        /// </summary>
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, Position = 1, ParameterSetName = "GetDeployedApplicationHealthUsingPolicy")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 2, ParameterSetName = "GetDeployedApplicationHealthUsingPolicy")]
        ...
        /// - All - Filter that matches input with any HealthState value. The value is 65535.
        /// </summary>
        [Parameter(Mandatory = false, Position = 3, ParameterSetName = "GetDeployedApplicationHealthUsingPolicy")]
        public int? DeployedServicePackagesHealthStateFilter
        {
            get;
            set;
        }
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 4, ParameterSetName = "GetDeployedApplicationHealthUsingPolicy")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 5, ParameterSetName = "GetDeployedApplicationHealthUsingPolicy")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 6, ParameterSetName = "GetDeployedApplicationHealthUsingPolicy")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 7, ParameterSetName = "GetDeployedApplicationHealthUsingPolicy")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 8, ParameterSetName = "GetDeployedApplicationHealthUsingPolicy")]
        ...
        /// empty by default.
        /// </summary>
        [Parameter(Mandatory = false, Position = 9, ParameterSetName = "GetDeployedApplicationHealthUsingPolicy")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 10, ParameterSetName = "GetDeployedApplicationHealthUsingPolicy")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 11, ParameterSetName = "GetDeployedApplicationHealthUsingPolicy")]
        ...
        protected override void ProcessRecordInternal()
        {
            try
            {
                ...
                var result = this.ServiceFabricClient.Applications.GetDeployedApplicationHealthUsingPolicyAsync(
