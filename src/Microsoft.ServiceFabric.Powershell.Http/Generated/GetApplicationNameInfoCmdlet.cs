...
namespace Microsoft.ServiceFabric.Powershell.Http
{
    ...
    public partial class GetApplicationNameInfoCmdlet : CommonCmdletBase
    {
        ...
        /// </summary>
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, Position = 0, ParameterSetName = "GetApplicationNameInfo")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 1, ParameterSetName = "GetApplicationNameInfo")]
        ...
        {
            var result = this.ServiceFabricClient.Services.GetApplicationNameInfoAsync(
