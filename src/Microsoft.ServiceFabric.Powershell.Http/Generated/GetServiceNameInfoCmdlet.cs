...
namespace Microsoft.ServiceFabric.Powershell.Http
{
    ...
    public partial class GetServiceNameInfoCmdlet : CommonCmdletBase
    {
        ...
        /// </summary>
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, Position = 0, ParameterSetName = "GetServiceNameInfo")]
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 1, ParameterSetName = "GetServiceNameInfo")]
        ...
        {
            var result = this.ServiceFabricClient.Partitions.GetServiceNameInfoAsync(
        ...
        {
            var outputResult = output as ServiceNameInfo;
