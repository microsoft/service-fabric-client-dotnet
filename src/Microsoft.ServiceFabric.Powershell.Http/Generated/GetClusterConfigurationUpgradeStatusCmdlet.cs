...
namespace Microsoft.ServiceFabric.Powershell.Http
{
    ...
    public partial class GetClusterConfigurationUpgradeStatusCmdlet : CommonCmdletBase
    {
        ...
        /// </summary>
        [Parameter(Mandatory = false, Position = 0, ParameterSetName = "GetClusterConfigurationUpgradeStatus")]
        ...
        protected override void ProcessRecordInternal()
        {
            try
            {
                var result = this.ServiceFabricClient.Cluster.GetClusterConfigurationUpgradeStatusAsync(
