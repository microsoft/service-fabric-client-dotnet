...
namespace Microsoft.ServiceFabric.Common
{
    ...
    /// in this list.
    /// </summary>
    public partial class PagedServiceResourceDescriptionList
    {
        /// <summary>
        ...
        public PagedServiceResourceDescriptionList(
            ...
            IEnumerable<ServiceResourceDescription> items = default(IEnumerable<ServiceResourceDescription>))
        {
        ...
        /// </summary>
        public IEnumerable<ServiceResourceDescription> Items { get; }
    }
}
