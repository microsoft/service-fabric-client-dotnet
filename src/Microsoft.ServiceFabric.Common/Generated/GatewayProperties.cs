...
namespace Microsoft.ServiceFabric.Common
{
    ...
    /// <summary>
    /// Describes properties of Gateway to bridge two networks.
    /// </summary>
    public partial class GatewayProperties
    {
        ...
        /// <param name="status">Status of the gateway resource. Possible values include: 'Invalid', 'Ready', 'Upgrading',
        /// 'Creating', 'Deleting', 'Failed'</param>
        /// <param name="statusDetails">Gives additional information about the current status of the gateay.</param>
        public GatewayProperties(
            ...
            GatewayResourceStatus? status = default(GatewayResourceStatus?),
        ...
        /// <summary>
        /// Gets status of the gateway resource. Possible values include: 'Invalid', 'Ready', 'Upgrading', 'Creating',
        /// 'Deleting', 'Failed'
        /// </summary>
        public GatewayResourceStatus? Status { get; }

        /// <summary>
        /// Gets gives additional information about the current status of the gateay.
        /// </summary>
