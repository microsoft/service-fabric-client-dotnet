...
namespace Microsoft.ServiceFabric.Common.Exceptions
{
    ...
    public class ServiceFabricException : Exception
    {
        ...
        /// </summary>
        public ServiceFabricException() : this(FabricErrorCodes.UNKNOWN, false)
        {
        }
        ...
        public ServiceFabricException(string message) : this(message, FabricErrorCodes.UNKNOWN, false)
        {
        }
        ...
        public ServiceFabricException(string message, Exception innerException) : this(message, innerException, FabricErrorCodes.UNKNOWN, false)
        {
        }
        ...
        public ServiceFabricException(FabricErrorCodes errorCode, bool isTransient) : this(string.Empty, errorCode, isTransient)
        {
        }
        ...
        /// <param name="errorCode">The error code associated with the exception.</param>
        /// <param name="isTransient">Indicating if its an transient exception. </param>
        public ServiceFabricException(string message, Exception inner, FabricErrorCodes errorCode, bool isTransient) : base(message, inner)
        {
        ...
        protected ServiceFabricException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
            if (info != null)
            {
