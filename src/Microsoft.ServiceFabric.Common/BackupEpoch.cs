...
namespace Microsoft.ServiceFabric.Common
{
    ...
    /// </summary>
    public partial class BackupEpoch
    {
        /// <summary>
        /// Initializes a new instance of the BackupEpoch class.
        /// </summary>
        /// <param name="configurationNumber">The current configuration number of this Epoch. The configuration number is an
        /// increasing value that is updated whenever the configuration of this replica set changes.</param>
        /// <param name="dataLossNumber">The current dataloss number of this Epoch. The data loss number property is an
        ...
        public BackupEpoch(
            string configurationNumber = default(string),
            string dataLossNumber = default(string))
        {
        ...
        /// </summary>
        public string ConfigurationNumber { get; }
        ...
        /// Primary replica.
        /// </summary>
        public string DataLossNumber { get; }
    }
}
