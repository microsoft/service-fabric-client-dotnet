...
namespace Microsoft.ServiceFabric.Client
{
    ...
    public partial interface IMeshGatewaysClient
    {
        ...
        /// </remarks>
        /// <param name ="gatewayResourceName">Service Fabric gateway resource name.</param>        
        /// <param name="descriptionFile">Json resource file containing the description of the gateway resource to be created or updated.</param>
