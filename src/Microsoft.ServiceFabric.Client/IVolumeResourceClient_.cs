...
namespace Microsoft.ServiceFabric.Client
{
    ...
    public partial interface IVolumeResourceClient
    {
        ...
        /// application.
        /// </remarks>
        /// <param name="resourceFile">Json resource file containing the description of the volume resource to be created or updated.</param>
        ...
        Task<VolumeResourceDescription> CreateVolumeResourceAsync(
            string resourceFile,
