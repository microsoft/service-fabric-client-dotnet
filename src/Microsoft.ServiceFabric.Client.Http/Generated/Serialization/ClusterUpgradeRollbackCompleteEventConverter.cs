...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ClusterUpgradeRollbackCompleteEvent" />.
    /// </summary>
    internal class ClusterUpgradeRollbackCompleteEventConverter
    {
        /// <summary>
        ...
        internal static ClusterUpgradeRollbackCompleteEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ClusterUpgradeRollbackCompleteEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new ClusterUpgradeRollbackCompleteEvent(
        ...
        internal static void Serialize(JsonWriter writer, ClusterUpgradeRollbackCompleteEvent obj)
        {
