...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ClusterNewHealthReportEvent" />.
    /// </summary>
    internal class ClusterNewHealthReportEventConverter
    {
        /// <summary>
        ...
        internal static ClusterNewHealthReportEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ClusterNewHealthReportEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new ClusterNewHealthReportEvent(
        ...
        internal static void Serialize(JsonWriter writer, ClusterNewHealthReportEvent obj)
        {
