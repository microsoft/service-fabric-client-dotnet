...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="PartitionHealthReportExpiredEvent" />.
    /// </summary>
    internal class PartitionHealthReportExpiredEventConverter
    {
        /// <summary>
        ...
        internal static PartitionHealthReportExpiredEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static PartitionHealthReportExpiredEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new PartitionHealthReportExpiredEvent(
        ...
        internal static void Serialize(JsonWriter writer, PartitionHealthReportExpiredEvent obj)
        {
