...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="NodeHealthReportCreatedEvent" />.
    /// </summary>
    internal class NodeHealthReportCreatedEventConverter
    {
        /// <summary>
        ...
        internal static NodeHealthReportCreatedEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static NodeHealthReportCreatedEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new NodeHealthReportCreatedEvent(
        ...
        internal static void Serialize(JsonWriter writer, NodeHealthReportCreatedEvent obj)
        {
