...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="NodeDeactivateStartedEvent" />.
    /// </summary>
    internal class NodeDeactivateStartedEventConverter
    {
        /// <summary>
        ...
        internal static NodeDeactivateStartedEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static NodeDeactivateStartedEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            do
            {
                ...
                else if (string.Compare("DeactivateIntent", propName, StringComparison.OrdinalIgnoreCase) == 0)
                {
            ...
            return new NodeDeactivateStartedEvent(
        ...
        internal static void Serialize(JsonWriter writer, NodeDeactivateStartedEvent obj)
        {
