...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="SecretResourcePropertiesBase" />.
    /// </summary>
    internal class SecretResourcePropertiesBaseConverter
    {
        /// <summary>
        ...
        internal static SecretResourcePropertiesBase Deserialize(JsonReader reader)
        {
        ...
        /// <param name="reader">The <see cref="T: Newtonsoft.Json.JsonReader" /> to read from.</param>
        /// <returns>The object Value.</returns>
        internal static SecretResourcePropertiesBase GetFromJsonProperties(JsonReader reader)
        {
            SecretResourcePropertiesBase obj = null;
