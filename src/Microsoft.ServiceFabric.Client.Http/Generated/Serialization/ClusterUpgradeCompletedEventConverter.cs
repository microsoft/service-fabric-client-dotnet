...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ClusterUpgradeCompletedEvent" />.
    /// </summary>
    internal class ClusterUpgradeCompletedEventConverter
    {
        /// <summary>
        ...
        internal static ClusterUpgradeCompletedEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ClusterUpgradeCompletedEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new ClusterUpgradeCompletedEvent(
        ...
        internal static void Serialize(JsonWriter writer, ClusterUpgradeCompletedEvent obj)
        {
