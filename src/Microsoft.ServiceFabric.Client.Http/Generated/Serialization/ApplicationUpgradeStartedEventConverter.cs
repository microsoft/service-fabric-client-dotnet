...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ApplicationUpgradeStartedEvent" />.
    /// </summary>
    internal class ApplicationUpgradeStartedEventConverter
    {
        /// <summary>
        ...
        internal static ApplicationUpgradeStartedEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ApplicationUpgradeStartedEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new ApplicationUpgradeStartedEvent(
        ...
        internal static void Serialize(JsonWriter writer, ApplicationUpgradeStartedEvent obj)
        {
