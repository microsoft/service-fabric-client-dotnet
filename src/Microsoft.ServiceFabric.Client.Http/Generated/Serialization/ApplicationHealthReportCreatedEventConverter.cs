...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ApplicationHealthReportCreatedEvent" />.
    /// </summary>
    internal class ApplicationHealthReportCreatedEventConverter
    {
        /// <summary>
        ...
        internal static ApplicationHealthReportCreatedEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ApplicationHealthReportCreatedEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new ApplicationHealthReportCreatedEvent(
        ...
        internal static void Serialize(JsonWriter writer, ApplicationHealthReportCreatedEvent obj)
        {
