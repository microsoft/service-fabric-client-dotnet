...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="StatelessReplicaNewHealthReportEvent" />.
    /// </summary>
    internal class StatelessReplicaNewHealthReportEventConverter
    {
        /// <summary>
        ...
        internal static StatelessReplicaNewHealthReportEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static StatelessReplicaNewHealthReportEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new StatelessReplicaNewHealthReportEvent(
        ...
        internal static void Serialize(JsonWriter writer, StatelessReplicaNewHealthReportEvent obj)
        {
