...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="WaitingChaosEvent" />.
    /// </summary>
    internal class WaitingChaosEventConverter
    {
        /// <summary>
        ...
        internal static WaitingChaosEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static WaitingChaosEvent GetFromJsonProperties(JsonReader reader)
        {
        ...
        internal static void Serialize(JsonWriter writer, WaitingChaosEvent obj)
        {
