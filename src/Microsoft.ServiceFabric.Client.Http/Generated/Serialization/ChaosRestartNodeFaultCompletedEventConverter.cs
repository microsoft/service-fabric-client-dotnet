...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ChaosRestartNodeFaultCompletedEvent" />.
    /// </summary>
    internal class ChaosRestartNodeFaultCompletedEventConverter
    {
        /// <summary>
        ...
        internal static ChaosRestartNodeFaultCompletedEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ChaosRestartNodeFaultCompletedEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new ChaosRestartNodeFaultCompletedEvent(
        ...
        internal static void Serialize(JsonWriter writer, ChaosRestartNodeFaultCompletedEvent obj)
        {
