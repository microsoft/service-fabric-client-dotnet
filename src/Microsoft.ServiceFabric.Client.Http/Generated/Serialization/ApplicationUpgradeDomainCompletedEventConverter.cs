...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ApplicationUpgradeDomainCompletedEvent" />.
    /// </summary>
    internal class ApplicationUpgradeDomainCompletedEventConverter
    {
        /// <summary>
        ...
        internal static ApplicationUpgradeDomainCompletedEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ApplicationUpgradeDomainCompletedEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new ApplicationUpgradeDomainCompletedEvent(
        ...
        internal static void Serialize(JsonWriter writer, ApplicationUpgradeDomainCompletedEvent obj)
        {
