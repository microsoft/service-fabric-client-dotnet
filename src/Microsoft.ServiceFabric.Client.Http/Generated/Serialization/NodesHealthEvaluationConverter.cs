...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="NodesHealthEvaluation" />.
    /// </summary>
    internal class NodesHealthEvaluationConverter
    {
        /// <summary>
        ...
        internal static NodesHealthEvaluation Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static NodesHealthEvaluation GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new NodesHealthEvaluation(
        ...
        internal static void Serialize(JsonWriter writer, NodesHealthEvaluation obj)
        {
