...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ApplicationUpgradeRollbackCompletedEvent" />.
    /// </summary>
    internal class ApplicationUpgradeRollbackCompletedEventConverter
    {
        /// <summary>
        ...
        internal static ApplicationUpgradeRollbackCompletedEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ApplicationUpgradeRollbackCompletedEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new ApplicationUpgradeRollbackCompletedEvent(
        ...
        internal static void Serialize(JsonWriter writer, ApplicationUpgradeRollbackCompletedEvent obj)
        {
