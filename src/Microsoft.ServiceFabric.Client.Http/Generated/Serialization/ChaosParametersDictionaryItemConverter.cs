...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ChaosParametersDictionaryItem" />.
    /// </summary>
    internal class ChaosParametersDictionaryItemConverter
    {
        /// <summary>
        ...
        internal static ChaosParametersDictionaryItem Deserialize(JsonReader reader)
        {
        ...
        internal static void Serialize(JsonWriter writer, ChaosParametersDictionaryItem obj)
        {
            // Required properties are always serialized, optional properties are serialized when not null.
            writer.WriteStartObject();
            writer.WriteProperty(obj.Key, "Key", JsonWriterExtensions.WriteStringValue);
            writer.WriteProperty(obj.Value, "Value", ChaosParametersConverter.Serialize);
