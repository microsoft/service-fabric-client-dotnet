...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ClusterHealth" />.
    /// </summary>
    internal class ClusterHealthConverter
    {
        /// <summary>
        ...
        internal static ClusterHealth Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ClusterHealth GetFromJsonProperties(JsonReader reader)
        {
            ...
            var nodeHealthStates = default(IEnumerable<NodeHealthState>);
            var applicationHealthStates = default(IEnumerable<ApplicationHealthState>);
