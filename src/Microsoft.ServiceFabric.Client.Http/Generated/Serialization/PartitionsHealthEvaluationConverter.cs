...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="PartitionsHealthEvaluation" />.
    /// </summary>
    internal class PartitionsHealthEvaluationConverter
    {
        /// <summary>
        ...
        internal static PartitionsHealthEvaluation Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static PartitionsHealthEvaluation GetFromJsonProperties(JsonReader reader)
        {
            ...
            do
            {
                ...
                else if (string.Compare("MaxPercentUnhealthyPartitionsPerService", propName, StringComparison.Ordinal) == 0)
                {
            ...
            return new PartitionsHealthEvaluation(
        ...
        internal static void Serialize(JsonWriter writer, PartitionsHealthEvaluation obj)
        {
