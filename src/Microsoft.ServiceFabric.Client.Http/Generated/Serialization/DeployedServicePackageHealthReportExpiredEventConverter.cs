...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="DeployedServicePackageHealthReportExpiredEvent" />.
    /// </summary>
    internal class DeployedServicePackageHealthReportExpiredEventConverter
    {
        /// <summary>
        ...
        internal static DeployedServicePackageHealthReportExpiredEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static DeployedServicePackageHealthReportExpiredEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            do
            {
                ...
                else if (string.Compare("ServiceManifest", propName, StringComparison.OrdinalIgnoreCase) == 0)
                {
            ...
            return new DeployedServicePackageHealthReportExpiredEvent(
        ...
        internal static void Serialize(JsonWriter writer, DeployedServicePackageHealthReportExpiredEvent obj)
        {
