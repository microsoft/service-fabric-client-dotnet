...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="NodeNewHealthReportEvent" />.
    /// </summary>
    internal class NodeNewHealthReportEventConverter
    {
        /// <summary>
        ...
        internal static NodeNewHealthReportEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static NodeNewHealthReportEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new NodeNewHealthReportEvent(
        ...
        internal static void Serialize(JsonWriter writer, NodeNewHealthReportEvent obj)
        {
