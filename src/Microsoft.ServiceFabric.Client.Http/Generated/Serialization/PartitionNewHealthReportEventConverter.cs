...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="PartitionNewHealthReportEvent" />.
    /// </summary>
    internal class PartitionNewHealthReportEventConverter
    {
        /// <summary>
        ...
        internal static PartitionNewHealthReportEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static PartitionNewHealthReportEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new PartitionNewHealthReportEvent(
        ...
        internal static void Serialize(JsonWriter writer, PartitionNewHealthReportEvent obj)
        {
