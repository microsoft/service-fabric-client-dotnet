...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ApplicationHealthReportExpiredEvent" />.
    /// </summary>
    internal class ApplicationHealthReportExpiredEventConverter
    {
        /// <summary>
        ...
        internal static ApplicationHealthReportExpiredEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ApplicationHealthReportExpiredEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new ApplicationHealthReportExpiredEvent(
        ...
        internal static void Serialize(JsonWriter writer, ApplicationHealthReportExpiredEvent obj)
        {
