...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="PartitionHealthState" />.
    /// </summary>
    internal class PartitionHealthStateConverter
    {
        /// <summary>
        ...
        internal static PartitionHealthState Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static PartitionHealthState GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new PartitionHealthState(
