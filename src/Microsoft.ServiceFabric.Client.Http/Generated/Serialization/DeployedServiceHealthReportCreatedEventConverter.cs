...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="DeployedServiceHealthReportCreatedEvent" />.
    /// </summary>
    internal class DeployedServiceHealthReportCreatedEventConverter
    {
        /// <summary>
        ...
        internal static DeployedServiceHealthReportCreatedEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static DeployedServiceHealthReportCreatedEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new DeployedServiceHealthReportCreatedEvent(
        ...
        internal static void Serialize(JsonWriter writer, DeployedServiceHealthReportCreatedEvent obj)
        {
