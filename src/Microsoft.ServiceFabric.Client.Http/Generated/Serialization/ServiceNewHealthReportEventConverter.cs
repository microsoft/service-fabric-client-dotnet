...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ServiceNewHealthReportEvent" />.
    /// </summary>
    internal class ServiceNewHealthReportEventConverter
    {
        /// <summary>
        ...
        internal static ServiceNewHealthReportEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ServiceNewHealthReportEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new ServiceNewHealthReportEvent(
        ...
        internal static void Serialize(JsonWriter writer, ServiceNewHealthReportEvent obj)
        {
