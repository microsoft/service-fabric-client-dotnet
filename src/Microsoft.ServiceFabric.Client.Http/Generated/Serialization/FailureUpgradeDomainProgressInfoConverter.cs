...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="FailureUpgradeDomainProgressInfo" />.
    /// </summary>
    internal class FailureUpgradeDomainProgressInfoConverter
    {
        /// <summary>
        ...
        internal static FailureUpgradeDomainProgressInfo Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static FailureUpgradeDomainProgressInfo GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new FailureUpgradeDomainProgressInfo(
        ...
        internal static void Serialize(JsonWriter writer, FailureUpgradeDomainProgressInfo obj)
        {
