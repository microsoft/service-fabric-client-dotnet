...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ContainerDeactivatedEvent" />.
    /// </summary>
    internal class ContainerDeactivatedEventConverter
    {
        /// <summary>
        ...
        internal static ContainerDeactivatedEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ContainerDeactivatedEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            do
            {
                ...
                else if (string.Compare("ImageName", propName, StringComparison.Ordinal) == 0)
                {
            ...
            return new ContainerDeactivatedEvent(
        ...
        internal static void Serialize(JsonWriter writer, ContainerDeactivatedEvent obj)
        {
