...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="NodeHealthEvaluation" />.
    /// </summary>
    internal class NodeHealthEvaluationConverter
    {
        /// <summary>
        ...
        internal static NodeHealthEvaluation Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static NodeHealthEvaluation GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new NodeHealthEvaluation(
        ...
        internal static void Serialize(JsonWriter writer, NodeHealthEvaluation obj)
        {
