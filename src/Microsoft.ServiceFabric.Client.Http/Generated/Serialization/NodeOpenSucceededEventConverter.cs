...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="NodeOpenSucceededEvent" />.
    /// </summary>
    internal class NodeOpenSucceededEventConverter
    {
        /// <summary>
        ...
        internal static NodeOpenSucceededEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static NodeOpenSucceededEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new NodeOpenSucceededEvent(
        ...
        internal static void Serialize(JsonWriter writer, NodeOpenSucceededEvent obj)
        {
