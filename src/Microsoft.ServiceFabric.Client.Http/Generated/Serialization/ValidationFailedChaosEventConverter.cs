...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ValidationFailedChaosEvent" />.
    /// </summary>
    internal class ValidationFailedChaosEventConverter
    {
        /// <summary>
        ...
        internal static ValidationFailedChaosEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ValidationFailedChaosEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new ValidationFailedChaosEvent(
        ...
        internal static void Serialize(JsonWriter writer, ValidationFailedChaosEvent obj)
        {
