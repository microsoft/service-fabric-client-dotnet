...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ApplicationUpgradeCompletedEvent" />.
    /// </summary>
    internal class ApplicationUpgradeCompletedEventConverter
    {
        /// <summary>
        ...
        internal static ApplicationUpgradeCompletedEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ApplicationUpgradeCompletedEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new ApplicationUpgradeCompletedEvent(
        ...
        internal static void Serialize(JsonWriter writer, ApplicationUpgradeCompletedEvent obj)
        {
