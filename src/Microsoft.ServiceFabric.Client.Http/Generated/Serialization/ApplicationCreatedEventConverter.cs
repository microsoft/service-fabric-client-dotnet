...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ApplicationCreatedEvent" />.
    /// </summary>
    internal class ApplicationCreatedEventConverter
    {
        /// <summary>
        ...
        internal static ApplicationCreatedEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ApplicationCreatedEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            var applicationDefinitionKind = default(string);
            ...
            do
            {
                ...
                {
                    applicationDefinitionKind = reader.ReadValueAsString();
                }
                else
                {
        ...
        internal static void Serialize(JsonWriter writer, ApplicationCreatedEvent obj)
        {
            ...
            writer.WriteProperty(obj.ApplicationDefinitionKind, "ApplicationDefinitionKind", JsonWriterExtensions.WriteStringValue);
