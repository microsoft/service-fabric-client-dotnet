...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ApplicationUpgradeStartEvent" />.
    /// </summary>
    internal class ApplicationUpgradeStartEventConverter
    {
        /// <summary>
        ...
        internal static ApplicationUpgradeStartEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ApplicationUpgradeStartEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new ApplicationUpgradeStartEvent(
        ...
        internal static void Serialize(JsonWriter writer, ApplicationUpgradeStartEvent obj)
        {
