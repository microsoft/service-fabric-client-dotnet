...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="DeployedApplicationNewHealthReportEvent" />.
    /// </summary>
    internal class DeployedApplicationNewHealthReportEventConverter
    {
        /// <summary>
        ...
        internal static DeployedApplicationNewHealthReportEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static DeployedApplicationNewHealthReportEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            do
            {
                ...
                else if (string.Compare("ApplicationInstanceId", propName, StringComparison.OrdinalIgnoreCase) == 0)
                {
            ...
            return new DeployedApplicationNewHealthReportEvent(
        ...
        internal static void Serialize(JsonWriter writer, DeployedApplicationNewHealthReportEvent obj)
        {
