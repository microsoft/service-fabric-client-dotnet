...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ClusterUpgradeRollbackStartedEvent" />.
    /// </summary>
    internal class ClusterUpgradeRollbackStartedEventConverter
    {
        /// <summary>
        ...
        internal static ClusterUpgradeRollbackStartedEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ClusterUpgradeRollbackStartedEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new ClusterUpgradeRollbackStartedEvent(
        ...
        internal static void Serialize(JsonWriter writer, ClusterUpgradeRollbackStartedEvent obj)
        {
