...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ApplicationNewHealthReportEvent" />.
    /// </summary>
    internal class ApplicationNewHealthReportEventConverter
    {
        /// <summary>
        ...
        internal static ApplicationNewHealthReportEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ApplicationNewHealthReportEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new ApplicationNewHealthReportEvent(
        ...
        internal static void Serialize(JsonWriter writer, ApplicationNewHealthReportEvent obj)
        {
