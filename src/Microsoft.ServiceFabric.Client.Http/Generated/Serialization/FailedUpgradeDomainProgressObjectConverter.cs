...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="FailedUpgradeDomainProgressObject" />.
    /// </summary>
    internal class FailedUpgradeDomainProgressObjectConverter
    {
        /// <summary>
        ...
        internal static FailedUpgradeDomainProgressObject Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static FailedUpgradeDomainProgressObject GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new FailedUpgradeDomainProgressObject(
        ...
        internal static void Serialize(JsonWriter writer, FailedUpgradeDomainProgressObject obj)
        {
