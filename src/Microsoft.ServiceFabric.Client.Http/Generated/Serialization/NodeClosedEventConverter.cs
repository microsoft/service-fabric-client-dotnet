...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="NodeClosedEvent" />.
    /// </summary>
    internal class NodeClosedEventConverter
    {
        /// <summary>
        ...
        internal static NodeClosedEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static NodeClosedEvent GetFromJsonProperties(JsonReader reader)
        {
        ...
        internal static void Serialize(JsonWriter writer, NodeClosedEvent obj)
        {
