...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="EntityHealthState" />.
    /// </summary>
    internal class EntityHealthStateConverter
    {
        /// <summary>
        ...
        internal static EntityHealthState Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static EntityHealthState GetFromJsonProperties(JsonReader reader)
        {
        ...
        internal static void Serialize(JsonWriter writer, EntityHealthState obj)
        {
