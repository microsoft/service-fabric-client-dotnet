...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ApplicationUpgradeRollbackStartedEvent" />.
    /// </summary>
    internal class ApplicationUpgradeRollbackStartedEventConverter
    {
        /// <summary>
        ...
        internal static ApplicationUpgradeRollbackStartedEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ApplicationUpgradeRollbackStartedEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            do
            {
                ...
                else if (string.Compare("CurrentApplicationTypeVersion", propName, StringComparison.OrdinalIgnoreCase) == 0)
                {
            ...
            return new ApplicationUpgradeRollbackStartedEvent(
        ...
        internal static void Serialize(JsonWriter writer, ApplicationUpgradeRollbackStartedEvent obj)
        {
