...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ApplicationTypeApplicationsHealthEvaluation" />.
    /// </summary>
    internal class ApplicationTypeApplicationsHealthEvaluationConverter
    {
        /// <summary>
        ...
        internal static ApplicationTypeApplicationsHealthEvaluation Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ApplicationTypeApplicationsHealthEvaluation GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new ApplicationTypeApplicationsHealthEvaluation(
        ...
        internal static void Serialize(JsonWriter writer, ApplicationTypeApplicationsHealthEvaluation obj)
        {
