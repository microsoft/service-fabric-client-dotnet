...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="NodeResult" />.
    /// </summary>
    internal class NodeResultConverter
    {
        /// <summary>
        ...
        internal static NodeResult Deserialize(JsonReader reader)
        {
        ...
        internal static void Serialize(JsonWriter writer, NodeResult obj)
        {
