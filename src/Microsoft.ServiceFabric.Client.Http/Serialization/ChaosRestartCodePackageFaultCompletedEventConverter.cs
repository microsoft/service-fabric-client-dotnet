...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ChaosRestartCodePackageFaultCompletedEvent" />.
    /// </summary>
    internal class ChaosRestartCodePackageFaultCompletedEventConverter
    {
        /// <summary>
        ...
        internal static ChaosRestartCodePackageFaultCompletedEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ChaosRestartCodePackageFaultCompletedEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new ChaosRestartCodePackageFaultCompletedEvent(
        ...
        internal static void Serialize(JsonWriter writer, ChaosRestartCodePackageFaultCompletedEvent obj)
        {
