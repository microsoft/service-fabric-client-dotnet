...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ReplicaHealthState" />.
    /// </summary>
    internal class ReplicaHealthStateConverter
    {
        /// <summary>
        ...
        internal static ReplicaHealthState Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ReplicaHealthState GetFromJsonProperties(JsonReader reader)
        {
        ...
        internal static void Serialize(JsonWriter writer, ReplicaHealthState obj)
        {
