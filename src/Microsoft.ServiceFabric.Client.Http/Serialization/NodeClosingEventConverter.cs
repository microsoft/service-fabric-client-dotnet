...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="NodeClosingEvent" />.
    /// </summary>
    internal class NodeClosingEventConverter
    {
        /// <summary>
        ...
        internal static NodeClosingEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static NodeClosingEvent GetFromJsonProperties(JsonReader reader)
        {
        ...
        internal static void Serialize(JsonWriter writer, NodeClosingEvent obj)
        {
