...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="DeployedApplicationsHealthEvaluation" />.
    /// </summary>
    internal class DeployedApplicationsHealthEvaluationConverter
    {
        /// <summary>
        ...
        internal static DeployedApplicationsHealthEvaluation Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static DeployedApplicationsHealthEvaluation GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new DeployedApplicationsHealthEvaluation(
        ...
        internal static void Serialize(JsonWriter writer, DeployedApplicationsHealthEvaluation obj)
        {
