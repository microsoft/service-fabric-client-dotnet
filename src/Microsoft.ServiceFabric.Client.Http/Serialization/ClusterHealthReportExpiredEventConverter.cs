...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ClusterHealthReportExpiredEvent" />.
    /// </summary>
    internal class ClusterHealthReportExpiredEventConverter
    {
        /// <summary>
        ...
        internal static ClusterHealthReportExpiredEvent Deserialize(JsonReader reader)
        {
        ...
        internal static void Serialize(JsonWriter writer, ClusterHealthReportExpiredEvent obj)
        {
