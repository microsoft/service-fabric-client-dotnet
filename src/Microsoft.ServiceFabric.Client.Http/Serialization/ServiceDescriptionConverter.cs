...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ServiceDescription" />.
    /// </summary>
    internal class ServiceDescriptionConverter
    {
        /// <summary>
        ...
        internal static ServiceDescription Deserialize(JsonReader reader)
        {
        ...
        internal static ServiceDescription GetFromJsonProperties(JsonReader reader)
        {
            ...
            {
                obj = StatefulServiceDescriptionConverter.GetFromJsonProperties(reader);
            }
            else if (propValue.Equals("Stateless", StringComparison.Ordinal))
            {
                obj = StatelessServiceDescriptionConverter.GetFromJsonProperties(reader);
            }
            else
            {
        ...
        internal static void Serialize(JsonWriter writer, ServiceDescription obj)
        {
            ...
            {
                StatelessServiceDescriptionConverter.Serialize(writer, (StatelessServiceDescription)obj);
            }
            else
            {
                throw new InvalidOperationException("Unknown ServiceKind.");
