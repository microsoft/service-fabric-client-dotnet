...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="InvokeQuorumLossResult" />.
    /// </summary>
    internal class InvokeQuorumLossResultConverter
    {
        /// <summary>
        ...
        internal static InvokeQuorumLossResult Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static InvokeQuorumLossResult GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new InvokeQuorumLossResult(
                errorCode: errorCode,
        ...
        internal static void Serialize(JsonWriter writer, InvokeQuorumLossResult obj)
        {
