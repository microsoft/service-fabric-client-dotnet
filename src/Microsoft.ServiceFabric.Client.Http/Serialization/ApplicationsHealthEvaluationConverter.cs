...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ApplicationsHealthEvaluation" />.
    /// </summary>
    internal class ApplicationsHealthEvaluationConverter
    {
        /// <summary>
        ...
        internal static ApplicationsHealthEvaluation Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ApplicationsHealthEvaluation GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new ApplicationsHealthEvaluation(
        ...
        internal static void Serialize(JsonWriter writer, ApplicationsHealthEvaluation obj)
        {
