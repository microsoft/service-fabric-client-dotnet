...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="SingletonPartitionInformation" />.
    /// </summary>
    internal class SingletonPartitionInformationConverter
    {
        /// <summary>
        ...
        internal static SingletonPartitionInformation Deserialize(JsonReader reader)
        {
