...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="SecondaryReplicatorStatus" />.
    /// </summary>
    internal class SecondaryReplicatorStatusConverter
    {
        /// <summary>
        ...
        internal static SecondaryReplicatorStatus Deserialize(JsonReader reader)
        {
        ...
        internal static void Serialize(JsonWriter writer, SecondaryReplicatorStatus obj)
        {
