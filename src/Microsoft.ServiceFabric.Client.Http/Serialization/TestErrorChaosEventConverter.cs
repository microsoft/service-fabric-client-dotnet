...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="TestErrorChaosEvent" />.
    /// </summary>
    internal class TestErrorChaosEventConverter
    {
        /// <summary>
        ...
        internal static TestErrorChaosEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static TestErrorChaosEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new TestErrorChaosEvent(
        ...
        internal static void Serialize(JsonWriter writer, TestErrorChaosEvent obj)
        {
