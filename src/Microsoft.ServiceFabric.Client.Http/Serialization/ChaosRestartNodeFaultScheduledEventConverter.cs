...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ChaosRestartNodeFaultScheduledEvent" />.
    /// </summary>
    internal class ChaosRestartNodeFaultScheduledEventConverter
    {
        /// <summary>
        ...
        internal static ChaosRestartNodeFaultScheduledEvent Deserialize(JsonReader reader)
        {
        ...
        internal static void Serialize(JsonWriter writer, ChaosRestartNodeFaultScheduledEvent obj)
        {
