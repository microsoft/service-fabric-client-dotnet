...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ServiceHealthReportCreatedEvent" />.
    /// </summary>
    internal class ServiceHealthReportCreatedEventConverter
    {
        /// <summary>
        ...
        internal static ServiceHealthReportCreatedEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ServiceHealthReportCreatedEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new ServiceHealthReportCreatedEvent(
        ...
        internal static void Serialize(JsonWriter writer, ServiceHealthReportCreatedEvent obj)
        {
