...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ApplicationUpgradeCompleteEvent" />.
    /// </summary>
    internal class ApplicationUpgradeCompleteEventConverter
    {
        /// <summary>
        ...
        internal static ApplicationUpgradeCompleteEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ApplicationUpgradeCompleteEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new ApplicationUpgradeCompleteEvent(
        ...
        internal static void Serialize(JsonWriter writer, ApplicationUpgradeCompleteEvent obj)
        {
