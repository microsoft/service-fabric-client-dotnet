...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="DeployedApplicationHealthReportCreatedEvent" />.
    /// </summary>
    internal class DeployedApplicationHealthReportCreatedEventConverter
    {
        /// <summary>
        ...
        internal static DeployedApplicationHealthReportCreatedEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static DeployedApplicationHealthReportCreatedEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new DeployedApplicationHealthReportCreatedEvent(
        ...
        internal static void Serialize(JsonWriter writer, DeployedApplicationHealthReportCreatedEvent obj)
        {
