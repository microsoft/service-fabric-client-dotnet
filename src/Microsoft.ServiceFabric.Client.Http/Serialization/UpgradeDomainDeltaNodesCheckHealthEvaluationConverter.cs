...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="UpgradeDomainDeltaNodesCheckHealthEvaluation" />.
    /// </summary>
    internal class UpgradeDomainDeltaNodesCheckHealthEvaluationConverter
    {
        /// <summary>
        ...
        internal static UpgradeDomainDeltaNodesCheckHealthEvaluation Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static UpgradeDomainDeltaNodesCheckHealthEvaluation GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new UpgradeDomainDeltaNodesCheckHealthEvaluation(
        ...
        internal static void Serialize(JsonWriter writer, UpgradeDomainDeltaNodesCheckHealthEvaluation obj)
        {
