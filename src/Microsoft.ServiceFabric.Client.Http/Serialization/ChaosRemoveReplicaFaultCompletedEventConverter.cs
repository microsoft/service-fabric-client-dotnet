...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ChaosRemoveReplicaFaultCompletedEvent" />.
    /// </summary>
    internal class ChaosRemoveReplicaFaultCompletedEventConverter
    {
        /// <summary>
        ...
        internal static ChaosRemoveReplicaFaultCompletedEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ChaosRemoveReplicaFaultCompletedEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new ChaosRemoveReplicaFaultCompletedEvent(
        ...
        internal static void Serialize(JsonWriter writer, ChaosRemoveReplicaFaultCompletedEvent obj)
        {
