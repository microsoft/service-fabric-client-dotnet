...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="PartitionHealthReportCreatedEvent" />.
    /// </summary>
    internal class PartitionHealthReportCreatedEventConverter
    {
        /// <summary>
        ...
        internal static PartitionHealthReportCreatedEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static PartitionHealthReportCreatedEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new PartitionHealthReportCreatedEvent(
        ...
        internal static void Serialize(JsonWriter writer, PartitionHealthReportCreatedEvent obj)
        {
