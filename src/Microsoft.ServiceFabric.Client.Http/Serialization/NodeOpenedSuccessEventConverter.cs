...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="NodeOpenedSuccessEvent" />.
    /// </summary>
    internal class NodeOpenedSuccessEventConverter
    {
        /// <summary>
        ...
        internal static NodeOpenedSuccessEvent Deserialize(JsonReader reader)
        {
        ...
        internal static void Serialize(JsonWriter writer, NodeOpenedSuccessEvent obj)
        {
