...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ResourceLimits" />.
    /// </summary>
    internal class ResourceLimitsConverter
    {
        /// <summary>
        ...
        internal static ResourceLimits Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ResourceLimits GetFromJsonProperties(JsonReader reader)
        {
            ...
            do
            {
                ...
                if (string.Compare("memoryInGB", propName, StringComparison.Ordinal) == 0)
                {
                    memoryInGB = reader.ReadValueAsDouble();
                }
                else if (string.Compare("cpu", propName, StringComparison.Ordinal) == 0)
                {
