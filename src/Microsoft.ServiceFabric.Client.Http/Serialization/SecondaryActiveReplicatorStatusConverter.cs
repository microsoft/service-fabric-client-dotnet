...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="SecondaryActiveReplicatorStatus" />.
    /// </summary>
    internal class SecondaryActiveReplicatorStatusConverter
    {
        /// <summary>
        ...
        internal static SecondaryActiveReplicatorStatus Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static SecondaryActiveReplicatorStatus GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new SecondaryActiveReplicatorStatus(
        ...
        internal static void Serialize(JsonWriter writer, SecondaryActiveReplicatorStatus obj)
        {
