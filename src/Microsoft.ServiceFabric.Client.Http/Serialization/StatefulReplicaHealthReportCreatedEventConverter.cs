...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="StatefulReplicaHealthReportCreatedEvent" />.
    /// </summary>
    internal class StatefulReplicaHealthReportCreatedEventConverter
    {
        /// <summary>
        ...
        internal static StatefulReplicaHealthReportCreatedEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static StatefulReplicaHealthReportCreatedEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            do
            {
                ...
                else if (string.Compare("ReplicaInstanceId", propName, StringComparison.Ordinal) == 0)
                {
            ...
            return new StatefulReplicaHealthReportCreatedEvent(
        ...
        internal static void Serialize(JsonWriter writer, StatefulReplicaHealthReportCreatedEvent obj)
        {
