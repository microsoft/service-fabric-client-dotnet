...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="StatefulServiceTypeDescription" />.
    /// </summary>
    internal class StatefulServiceTypeDescriptionConverter
    {
        /// <summary>
        ...
        internal static StatefulServiceTypeDescription Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static StatefulServiceTypeDescription GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new StatefulServiceTypeDescription(
        ...
        internal static void Serialize(JsonWriter writer, StatefulServiceTypeDescription obj)
        {
