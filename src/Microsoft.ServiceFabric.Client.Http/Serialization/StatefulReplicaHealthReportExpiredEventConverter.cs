...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="StatefulReplicaHealthReportExpiredEvent" />.
    /// </summary>
    internal class StatefulReplicaHealthReportExpiredEventConverter
    {
        /// <summary>
        ...
        internal static StatefulReplicaHealthReportExpiredEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static StatefulReplicaHealthReportExpiredEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new StatefulReplicaHealthReportExpiredEvent(
        ...
        internal static void Serialize(JsonWriter writer, StatefulReplicaHealthReportExpiredEvent obj)
        {
