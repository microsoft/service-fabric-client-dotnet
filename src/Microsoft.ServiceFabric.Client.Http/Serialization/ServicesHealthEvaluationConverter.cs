...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ServicesHealthEvaluation" />.
    /// </summary>
    internal class ServicesHealthEvaluationConverter
    {
        /// <summary>
        ...
        internal static ServicesHealthEvaluation Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ServicesHealthEvaluation GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new ServicesHealthEvaluation(
        ...
        internal static void Serialize(JsonWriter writer, ServicesHealthEvaluation obj)
        {
