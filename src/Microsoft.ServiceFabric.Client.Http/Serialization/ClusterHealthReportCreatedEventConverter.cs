...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ClusterHealthReportCreatedEvent" />.
    /// </summary>
    internal class ClusterHealthReportCreatedEventConverter
    {
        /// <summary>
        ...
        internal static ClusterHealthReportCreatedEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ClusterHealthReportCreatedEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new ClusterHealthReportCreatedEvent(
        ...
        internal static void Serialize(JsonWriter writer, ClusterHealthReportCreatedEvent obj)
        {
