...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="NodeCloseEvent" />.
    /// </summary>
    internal class NodeCloseEventConverter
    {
        /// <summary>
        ...
        internal static NodeCloseEvent Deserialize(JsonReader reader)
        {
        ...
        internal static void Serialize(JsonWriter writer, NodeCloseEvent obj)
        {
